...
class EpisodicMemory(Base):
    ...
    # Phase A'' retroactive (Phase 6 commit 7): communication_mode tag on
    # Alicia-away memories so layer-5 filtering honors the constraint on read.
    # Non-Alicia rows leave this NULL.
